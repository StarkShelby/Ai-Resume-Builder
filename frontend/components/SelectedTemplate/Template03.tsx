                ...
                {!previewMode && (
                    <div className="mt-4">
                        ...
                        <button
                            ...
                            className="bg-white text-[#2c7873] px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-100 no-print"
                        >
                            Upload Photo
                        </button>
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        {!previewMode && (
                            <button
                                ...
                                className="mt-3 text-sm bg-[#2c7873] text-white px-3 py-1.5 rounded hover:bg-[#3d9b96] w-full no-print"
                            >
                                + Add Skill
                            </button>
                        )}
                        ...
                        <div className="flex justify-between items-center mb-3">
                            ...
                            {!previewMode && (
                                <button
                                    ...
                                    className="text-sm bg-[#2c7873] text-white px-3 py-1.5 rounded-md hover:bg-[#3d9b96] no-print"
                                >
                                    + Add
                                </button>
                            )}
                                    ...
                                    <div className="mt-2 space-y-1">
                                        ...
                                        {!previewMode && (
                                            <button
                                                ...
                                                className="text-sm text-[#2c7873] hover:underline mt-1 no-print"
                                            >
                                                + Add Bullet
                                            </button>
                                        )}
