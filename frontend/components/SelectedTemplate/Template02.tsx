...
export default function Template02({
    ...
    const summary =
        typeof data?.summary === "string" && data.summary.trim() !== ""
            ? data.summary
            : `Passionate software engineer with expertise in full-stack development, cloud architecture, and agile methodologies. Proven track record of delivering scalable solutions.`;
    ...
    return (
        ...
        >
            <div className="flex">
                ...
                <aside className="w-1/3 bg-[#1e3a5f] text-white p-8 flex flex-col gap-6">
                    {/* Photo */}
                    <div className="w-32 h-32 rounded-full overflow-hidden bg-white mx-auto flex items-center justify-center border-4 border-white shadow-lg">
                        {personal.photo ? (
                            <img
                                src={personal.photo}
                                alt="profile"
                    ...
                    {!previewMode && (
                        <div className="w-full text-center">
                            ...
                            <button
                                ...
                                className="bg-white text-[#1e3a5f] px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-100 no-print"
                            >
                                Upload Photo
                            </button>
                        </div>
                    ...
                    <div className="w-full">
                        <h3 className="text-lg font-bold mb-4 pb-2 border-b-2 border-white/30">
                            CONTACT
                        </h3>
                        <div className="space-y-3 text-sm">
                            ...
                            <div>
                                ...
                                <div
                                    contentEditable={!previewMode}
                                    suppressContentEditableWarning
                                    onBlur={handleBlur("personalInfo", "github")}
                                    data-placeholder="GitHub profile"
                                    className="editable-placeholder break-words"
                                >
                                    {personal.github || ""}
                                </div>
                            ...
                            <div>
                                <div className="text-xs text-white/60 mb-1">Website</div>
                                <div
                                    contentEditable={!previewMode}
                                    suppressContentEditableWarning
                    ...
                    <div className="w-full">
                            ...
                            {skills.map((s, i) => (
                                <div key={i} className="flex items-center justify-between">
                                    <div
                                        ...
                                        className="text-sm bg-white/10 px-3 py-1.5 rounded flex-1"
                                    >
                                        {s}
                                    </div>
                                    {!previewMode && (
                                        <button
                                            ...
                                            className="ml-2 text-xs text-red-300 hover:text-red-100 no-print"
                                        >
                                            ×
                                        </button>
                                    )}
                        ...
                        {!previewMode && (
                            <button
                                ...
                                className="mt-3 text-sm bg-white/20 text-white px-3 py-1.5 rounded hover:bg-white/30 w-full no-print"
                            >
                                + Add Skill
                            </button>
                        )}
                ...
                <section className="w-2/3 bg-white p-10">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="h-1 bg-[#1e3a5f] mt-4 w-24" />
                    </div>

                    {/* Profile Summary */}
                    <div className="mb-8">
                        <h3 className="text-xl font-bold text-[#1e3a5f] mb-3 uppercase tracking-wide">
                    ...
                    <div className="mb-8">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-xl font-bold text-[#1e3a5f] uppercase tracking-wide">
                                Work Experience
                            </h3>
                            {!previewMode && (
                                <button
                        ...
                        <div className="space-y-6">
                            ...
                            {experience.map((exp, idx) => (
                                <div
                                    key={idx}
                                    className="border-l-4 border-[#1e3a5f] pl-4 pb-4"
                                >
                                    <div className="flex justify-between items-start mb-2">
                                        <div className="flex-1">
                                            ...
                                            <div
                                                contentEditable={!previewMode}
                                                suppressContentEditableWarning
                                                className="editable-placeholder text-gray-600 font-medium"
                                    ...
                                    <div className="mt-3 space-y-1">
                                        {exp.bullets?.map((bullet: string, bIdx: number) => (
                                            <div key={bIdx} className="flex items-start gap-2">
                                                <span className="mt-1.5 text-[#1e3a5f] select-none">
                                                    •
                                                </span>
                                                <div
                                                    contentEditable={!previewMode}
                                        ...
                                        {!previewMode && (
                                            <button
                                                ...
                                                className="text-sm text-[#1e3a5f] hover:underline mt-1 no-print"
                                            >
                                                + Add Bullet Point
                                            </button>
                                        )}
