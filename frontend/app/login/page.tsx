        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 p-8 sm:p-10 transform transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="space-y-3 mb-6">
              <a
                href={`${process.env.FRONTEND_URL}/api/auth/google`}
              ...
              <a
                href={`${process.env.BACKEND_URL}/api/auth/github`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="email"
                    required
                    className="block w-full pl-12 pr-4 py-3.5 bg-white border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full pl-12 pr-12 py-3.5 bg-white border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
                    placeholder="••••••••"
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600 text-sm">
                ...
                <Link href="/signup" className="font-semibold text-purple-600 hover:text-purple-700 underline underline-offset-2 transition-colors">
                  Sign up for free
                </Link>
              </p>
            </div>
